...
export interface HighlightsBarProps {
  ...
  ariaLabel?: string
  /**
   * Also show the bar from the `md` breakpoint up, as a static row of 8 large
   * circles that fits the page width without scrolling. Off by default — the
   * homepage drives it from the topline's Show/Hide Highlights Bar control.
   */
 ...
 * ground, unless `showOnDesktop` lays it out there as a static 8-across row.
 * Each circle is a plain link to a category page.
 */
